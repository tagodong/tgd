...
parser.add_argument('--datadir', default="E:\\Dataset_3D_volumetric_images\\movingtest", help='base data directory')
parser.add_argument('--atlas', default="E:\\Dataset_3D_volumetric_images\\atlas.nii.gz",help='atlas filename (default: data/atlas_norm.npz)')
...
parser.add_argument('--steps-per-epoch', type=int, default=20, help='frequency of model saves (default: 100)')
