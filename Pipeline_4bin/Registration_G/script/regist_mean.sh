...
do
    ...
    mean_template=$green_dir/0$j/g/template/mean_template.nii
    ...
    do
        ...
        cmtk make_initial_affine --principal-axes ${green_path}/Green${k}.nii ${red_path}/Red${k}.nii ${red_path}/initial${k}.xform
        
        # Generate affine matrix.
        cmtk registration --initial ${red_path}/initial${k}.xform --dofs 9,12 --exploration 8 --accuracy 0.05 --cr -o ${red_path}/affine${k}.xform ${green_path}/Green${k}.nii ${red_path}/Red${k}.nii

        # Apply affine matrix.
        cmtk reformatx -o ${red_path}/Red_R2G${k}.nii --floating ${red_path}/Red${k}.nii ${green_path}/Green${k}.nii  ${red_path}/affine${k}.xform

        # Initialize affine matrix.
        cmtk make_initial_affine --principal-axes $mean_template ${green_path}/Green${k}.nii ${green_path}/initial${k}.xform
        
        # Generate affine matrix.
        cmtk registration --initial ${green_path}/initial${k}.xform --dofs 9,12 --exploration 8 --accuracy 0.05 --cr -o ${green_path}/affine${k}.xform $mean_template ${green_path}/Green${k}.nii
        ...
        cmtk reformatx -o ${regist_red_path}/regist_red_1_${k}.nii --floating ${red_path}/Red_R2G${k}.nii $mean_template ${green_path}/affine${k}.xform
