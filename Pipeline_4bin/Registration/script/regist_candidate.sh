...
antsRegistration -d 3 --float 1 -o [${template_path}/Rigid_,${template_path}/zbb_Rigid.nii.gz] -n NearestNeighbor -t Rigid[0.1] -m GC[$mean_template,$zbbfish,1,32,Regular,0.25] -c [200x200x200x100,1e-8,10] -f 12x8x4x2 -s 4x3x2x1

antsRegistration -d 3 --float 1 -o [${template_path}/Affine_,${template_path}/zbb_Affine.nii.gz] -n NearestNeighbor -t Affine[0.1] -m GC[$mean_template,${template_path}/zbb_Rigid.nii.gz,1,32,Regular,0.25] -c [200x200x200x100,1e-8,10] -f 12x8x4x2 -s 4x3x2x1

antsRegistration -d 3 --float 1 -o [${template_path}/SyN_,${template_path}/zbb_SyN.nii.gz] -n NearestNeighbor -t SyN[0.05,6,0.5] -m CC[$mean_template,${template_path}/zbb_Affine.nii.gz,1,2] -c [200x200x200x200x10,1e-7,10] -f 12x8x4x2x1 -s 4x3x2x1x0
