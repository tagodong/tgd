...
% tau_r = 0.38;
% tau_d = 2;
% g1 = exp(-1/(tau_d*r)) + exp(-1/(tau_r*r));
% g2 = -exp(-1/(tau_d*r)) * exp(-1/(tau_r*r));
% 
% g_ = exp(-1/(tau_d*r));
...
function [spike,denoise_ca,g,sn,lam,b] = deconv_OASIS(detrend_ca,sequences,lambda_value)
    ...
    addpath(genpath('C:\Users\Public\code\OASIS_matlab'));
    oasis_setup;
    ...
    %         'maxIter',100);
            ...
            [c, s, par]=deconvolveCa(y, 'ar1','foopsi','optimize_pars', true,'optimize_b', true,...  
