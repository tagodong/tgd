...
sample_data(:,2) = sample_data(:,2)-85;
sample_data(sample_data(:,2)<=0,2) = 1;
...
ObjFcn = helperBayesOptLSTM(train_feature_cell,train_lable,val_feature_cell,categorical(signal_val.class));
