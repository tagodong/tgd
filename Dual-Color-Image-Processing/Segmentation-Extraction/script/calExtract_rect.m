...
tic;
[G_trace,Coherence_G] = traceExtract_rect(path_g,pre_name_green,seg_regions,water_corMap,info_data,start_frame,batch_size,end_frame,write_flag);
...
R_trace = traceExtract_rect(path_r,pre_name_red,seg_regions,water_corMap,info_data,start_frame,batch_size,end_frame,write_flag);
