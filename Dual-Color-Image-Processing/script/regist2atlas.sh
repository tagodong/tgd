...
do
    ...
    do
        ...
        antsApplyTransforms -d 3 -v 0 --float 1 -n WelchWindowedSinc -i $path_g/demons_green_3_$j.nii -r $zbb_atlas -o $path_ants_g/ants_g_$j.nii \
        -t ${regist_out_path}/mean2atlas_1Warp.nii.gz -t ${regist_out_path}/mean2atlas_0GenericAffine.mat

        antsApplyTransforms -d 3 -v 0 --float 1 -n WelchWindowedSinc -i $path_r/demons_red_3_$j.nii -r $zbb_atlas -o $path_ants_r/ants_r_$j.nii \
        -t ${regist_out_path}/mean2atlas_1Warp.nii.gz -t ${regist_out_path}/mean2atlas_0GenericAffine.mat
