function reConstruction_norm(file_path_red,file_path_green,red_flag,heart_flag,red_PSF,green_PSF,atlas,crop_size,start_frame,step_size,end_frame,tform,x_shift,gpu_index)
