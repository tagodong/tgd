function crop_fix_2nd_new(file_path_red,file_path_green,startFrame,stepSize,endFrame,num_flag)
    ...
    % zbbfish = niftiread('/home/d1/atlas-zebrafish/test.nii');
    % Mask = zbbfish>0;
    ...
    for i = startFrame:stepSize:endFrame
        ...
        % red_image_crop_2nd=uint16(double(red_image_crop_2nd));
        % green_image_crop_2nd=uint16(double(green_image_crop_2nd));
