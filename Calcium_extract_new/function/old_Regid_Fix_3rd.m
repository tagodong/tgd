function old_Regid_Fix_3rd(file_Path_Green,startFrame,stepSize,endFrame,mod)
    ...
    if mod == 1
        ...
        refer_image = niftiread(fullfile(file_Path_Green,'mean_template_2.nii'));
    end
    ...
    for ii = startFrame:stepSize:endFrame
        ...
        regist_green_mat_path_3 = fullfile(file_Path_Green,'regist_green_mat_3/00');
        regist_3_green_name_out = ['green_regist_3_',num2str(i),'.mat'];

        
        % if exist(fullfile(regist_green_mat_path_3,regist_3_green_name_out))
        %     continue;
        % end
