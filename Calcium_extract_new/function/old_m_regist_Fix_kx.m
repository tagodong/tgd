function old_m_regid_Fix_kx(file_Path_Green,startFrame,stepSize,endFrame,regid_num,mod,num_flag)
    ...
    if regid_num == 2
        ...
        spmd
            if startFrame+(spmd_num*labindex-1)*stepSize <= endFrame
                old_Crop_Fix_2nd_kx(file_Path_Green,startFrame+spmd_num*(labindex-1)*stepSize,stepSize,startFrame+(spmd_num*labindex-1)*stepSize,num_flag);
            else
                old_Crop_Fix_2nd_kx(file_Path_Green,startFrame+spmd_num*(labindex-1)*stepSize,stepSize,endFrame,num_flag);
            end
        end
        toc;
        ...
        spmd
            gpuDevice(labindex);
            if startFrame+(spmd_num*labindex-1)*stepSize <= endFrame
                old_Regid_Fix_3rd_kx(file_Path_Green,startFrame+spmd_num*(labindex-1)*stepSize,stepSize,startFrame+(spmd_num*labindex-1)*stepSize,mod,num_flag);
            else
                old_Regid_Fix_3rd_kx(file_Path_Green,startFrame+spmd_num*(labindex-1)*stepSize,stepSize,endFrame,mod,num_flag);
            end
        end
        toc;
